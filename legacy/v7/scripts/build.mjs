...
const waveAStyles = await readFile('src/wave-a.css', 'utf8');
const hotfixStyles = await readFile('src/hotfix.css', 'utf8');
await writeFile('dist/assets/styles.css', `${baseStyles}\n${ultraStyles}\n${lifeOsStyles}\n${waveAStyles}\n${hotfixStyles}\n`);
const html = await readFile('index.html', 'utf8');
await writeFile('dist/index.html', html);
console.log('Build Quotidien V7.1.3 terminé dans dist/.');
